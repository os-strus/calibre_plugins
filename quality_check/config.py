...
PLUGIN_MENUS = OrderedDict([
       ...
       ('check_authors_publisher',      {'name': _('Check authors same as publisher'),         'cat':'metadata', 'sub_menu': _('Check metadata'), 'group': 5, 'excludable': True,  'image': 'user_profile.png',        'tooltip':_('Find books with autors same as publisher')}),
       ('check_title_part_duplicate',   {'name': _('Check title with duplicate part'),      'cat':'metadata', 'sub_menu': _('Check metadata'), 'group': 5, 'excludable': True,  'image': 'images/check_book.png',      'tooltip':_('Find books with part of title duplicated')}),
       ('check_series_in_title',           {'name': _('Check title include series name'),      'cat':'metadata', 'sub_menu': _('Check metadata'), 'group': 5, 'excludable': True,  'image': 'images/check_book.png',      'tooltip':_('Find books with series name in title')}),
       
       ('check_titles_series',      {'name': _('Check titles with series'),       'cat':'metadata', 'sub_menu': _('Check metadata'), 'group': 6, 'excludable': True,  'image': 'images/check_titleseries.png',         'tooltip':_('Find titles with possible series info in their name')}),
       ('check_title_case',         {'name': _('Check titles for title case'),    'cat':'metadata', 'sub_menu': _('Check metadata'), 'group': 6, 'excludable': True,  'image': 'images/check_titlecase.png',           'tooltip':_('Find titles which are candidates to apply the titlecase function to')}),
